...
] = "postgresql://postgres:wykRJb.HvkkpVn9@db.psujsjvxctszhfxhduzk.supabase.co:5432/postgres"
...
class PoiView(ModelView):
    ...
    show_fieldsets = [
        ("Summary", {"fields": ["id", "name", "category", "subcategory"]}),
        (
            "Address",
            {
                "fields": [
    ...
    add_columns = edit_columns = [
        ...
        "notes",
        "google_place_id",
        "google_place_updated_time",
        "updated_time",
    ]
    # add_columns = edit_columns = ['is_active', 'name', 'category']
